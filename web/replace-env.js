...
const configurations = {
  serve: [
    {
      description: 'Uncomment line with FAQ_BACK_URL and localhost',
      test: (line) =>
        line.includes('FAQ_BACK_URL') &&
        line.includes('localhost') &&
        line.startsWith('#'), // Check if the line is commented
      action: (line) => line.replace(/^#\s*/, ''), // Uncomment the line
    },
    {
      description: 'Comment line with FAQ_BACK_URL and assets',
      test: (line) =>
        line.includes('FAQ_BACK_URL') &&
        line.includes('.com') &&
  ...
  build: [
    {
      description: 'Comment line with FAQ_BACK_URL and localhost',
      test: (line) =>
        line.includes('FAQ_BACK_URL') &&
        line.includes('localhost') &&
        !line.startsWith('#'), // Check if the line is not commented
    ...
    {
      description: 'Uncomment line with FAQ_BACK_URL and assets',
      test: (line) =>
        line.includes('FAQ_BACK_URL') &&
        line.includes('.com') &&
        line.startsWith('#'), // Check if the line is commented
